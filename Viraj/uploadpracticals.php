    ...
    <div class="container d-flex justify-content-center">
        <div class="col-10">
            <div class="mb-3 mt-4">
                ...
                <input type="email" class="form-control" id="enterpracticaltitle" placeholder="Practical Title">
            </div>
            <div class="mb-3 mt-4">
                <label for="exampleFormControlInput1" class="upl-txt">Enter Video Link</label>
                <input type="email" class="form-control" id="enterlink" placeholder="Video Link">
            </div>
            <div class="d-flex justify-content-center">
                <button class="prac-btn" onclick="uploadpractical();">Upload Practicles</button>
            </div>
        </div>
    </div>
