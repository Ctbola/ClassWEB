    ...
    for ($i = 0; $i < $note_num; $i++) {
        ...
        <div class="d-grid justify-content-center" id="basicSearchResult">
            <div class="card mb-3 " style="max-width: 840px;">
                <div class="row g-0">
                    <?php
                    $img_rs = Database::search("SELECT * FROM `note_img` WHERE `notes_id`='" . $note_data["id"] . "' LIMIT 1 ");
                    $img_data = $img_rs->fetch_assoc();
                    ?>
                    <div class="col-md-6">
                        <img src="<?php echo $img_data ["img_link"]; ?>" class="img-fluid rounded-start">
                    </div>
                    <div class="col-md-6">
                        <div class="card-body">
                            <a href="#">
                            ...
                            <p class="card-text "><small class="text-body-secondary">
                                ...
                                <a href='<?php echo "singleNoteVIew.php?id=" . $note_data["id"]; ?>' class="btn btn-success">Learn More</a>
                        </div>
                    </div>
                </div>
            </div>
